/*
    Access control for super-admins, admins and all organizations. Organizations won't be able to create jobs if they've reached their job limit.
*/

import { type Access, checkRole } from '@/payload/access'
import { isOrganization } from '@/utilities/getRole'

export const SA_A_O_jobsAllowed: Access = ({ req: { user } }) => {
  if (user) {
