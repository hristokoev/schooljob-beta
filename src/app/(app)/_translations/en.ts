export const en = {
  ...
  applyForm: {
    ...
    consents: {
      processingOfPersonalData: 'I agree to the <Link>processing of personal data</Link>',
    },
    validation: {
      ...
      processingOfPersonalData: 'You must agree to the processing of personal data.',
    },
  },
  CTA: {
  ...
  editJob: {
    ...
    order: 'Membership',
    orderDescription: "Select the membership you've purchased and link your new job to it.",
    title: 'Title',
  ...
  membership: {
    ...
    getNow: 'Get Now',
    footer: 'With buying this membership, you agree to our <Link>terms and conditions</Link>.',
    note: "If you haven't found the right package for you, please contact us.",
    loading: 'Loading...',
  ...
  '404': {
    ...
    description:
      'Head to our <Link>home page</Link> that does exist, or try double-checking the URL.',
  },
  errors: {
  ...
  organization: {
    ...
    noDescriptionPrivate:
      "You don't have any description yet. How about writing something about your company?",
    noDescriptionPublic:
      'Oh, it appears that <strong>{title}</strong> has not provided any information about themselves yet.',
    vatId: 'VAT ID',
  },
  job: {
    skills: 'Skills',
  ...
  accountSettings: {
    ...
    email: 'Email',
    emailDescription:
      'The email address you use to log in. Contact us to change your email address.',
    emailPlaceholder: 'Email',
    password: 'Password',
