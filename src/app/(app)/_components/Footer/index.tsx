      ...
      <Gutter>
        <div className="grid gap-8 py-8 sm:grid-cols-12 md:py-12">
          <div className="flex flex-col max-sm:order-1 sm:col-span-6 lg:col-span-3">
            ...
            <ul className="mb-1 mt-4 flex space-x-4">
              <li>
                <a
          ...
          <div className="sm:col-span-6 lg:col-span-2">
            <h6 className="mb-2 text-sm font-extrabold text-white">{t('footer.information')}</h6>
            <ul className="space-y-2 text-sm">
              <li>
                <a className="text-zinc-100 transition hover:text-zinc-300" href="#0">
                  {t('footer.idea')}
                </a>
              </li>
              <li>
        ...
        <ul className="flex space-x-12 pb-6 text-sm">
          ...
          <li>
            <a className="text-zinc-100 transition hover:text-zinc-300" href="#0">
              {t('footer.bottomLinks.personalData')}
            </a>
          </li>
          <li>
            <a className="text-zinc-100 transition hover:text-zinc-300" href="#0">
